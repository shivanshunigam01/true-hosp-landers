  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="py-20 md:py-28 bg-background">
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-foreground mb-6">Why Choose Us for Women's Care?</h2>
      ...
      <section className="py-20 md:py-28 bg-secondary">
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-foreground mb-6">Our Gynecology Services</h2>
            <p className="text-muted-foreground text-lg max-w-3xl mx-auto leading-relaxed">
      ...
      <section className="py-20 md:py-28 bg-background">
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-foreground mb-6">Meet Our Gynecologists</h2>
            <p className="text-muted-foreground text-lg max-w-3xl mx-auto leading-relaxed">
      ...
      <section className="py-20 md:py-28 bg-gradient-to-br from-secondary to-accent">
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-foreground mb-6">Patient Testimonials</h2>
            <p className="text-muted-foreground text-lg max-w-3xl mx-auto leading-relaxed">
