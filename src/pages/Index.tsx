        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center animate-fade-in">
            ...
            <p className="text-xl md:text-2xl mb-8 opacity-90">
              Your trusted partner in health. Providing expert medical care with
              compassion and advanced technology.
            </p>
            <p className="text-lg mb-12 opacity-80">
              Sector 52, Gurugram | NABH Certified | 24×7 Emergency Care
            </p>
            <Button size="lg" variant="secondary" asChild>
              <a href="tel:9211731007">Call +91-9211731007</a>
            </Button>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
              Expert care across multiple medical specialties, all under one
              roof
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto">
            ...
            <div className="bg-gradient-card rounded-2xl shadow-card hover:shadow-hover transition-all duration-300 overflow-hidden group">
              <div className="p-8">
                ...
                <p className="text-muted-foreground mb-6">
                  Expert general and laparoscopic surgery with advanced
                  techniques for faster recovery and minimal scarring.
                </p>
            ...
            <div className="bg-gradient-card rounded-2xl shadow-card hover:shadow-hover transition-all duration-300 overflow-hidden group">
              <div className="p-8">
                ...
                <p className="text-muted-foreground mb-6">
                  Comprehensive gynecology and maternity care with personalized
                  attention for every woman's health needs.
                </p>
                <ul className="space-y-2 mb-6 text-sm text-muted-foreground">
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-muted-foreground text-lg mb-8">
              Our expert doctors are here to help. Call us or visit our hospital
              in Sector 52, Gurugram.
            </p>
